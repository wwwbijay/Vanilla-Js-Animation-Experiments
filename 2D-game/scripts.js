window.addEventListener('load', function(){
    ...
    class UI{
        ...
        draw(context){
            ...
            context.fillText( 'Timer: ' + parseInt(this.game.gameTime/1000).toFixed(1), this.game.width - 180 , 40);
            ...
            context.fillText(message1, this.game.width * 0.5, this.game.height * 5 -40);
            context.font = '25px' + this.fontFamily;
            context.fillText(message2, this.game.width * 0.5, this.game.height * 5 + 40);
            context.restore();
        }
